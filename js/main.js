...
function isoCheckboxChange(category){
    ...
    // }
    //
    var checked = d3.selectAll(".precision_checkbox")[0]
    for (i=0; i<checked.length; i++) {
